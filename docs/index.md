...
[Start with the Roadmap](#your-roadmap){ .md-button .md-button--primary }
...
<p class="roadmap-credit">Designed by the AI/ML Vertical Lead for MIC members — not a generic template.</p>

Click any node to jump straight to that topic, or check it off as you track your own progress through it — saved right in your browser. Each stage builds on the one before it. Prefer tables and timing estimates instead? See the [full written roadmap](roadmap.md).

<div id="roadmap-app" class="roadmap-app" data-roadmap-src="assets/data/roadmap.json">
  <p>Loading roadmap…</p>
</div>
...
<div class="hub-card" markdown>
<span class="hub-level-badge beginner">Beginner</span>

### [Foundations](foundations/index.md)
Python, linear algebra, calculus, probability, and statistics for AI.
</div>

<div class="hub-card" markdown>
<span class="hub-level-badge intermediate">Intermediate</span>

### [Machine Learning](machine-learning/index.md)
Supervised and unsupervised learning, evaluation, feature engineering.
</div>
...
Neural networks, CNNs, transformers, PyTorch and TensorFlow.
</div>
...
Image processing, detection, segmentation, vision transformers.
</div>
...
Tokenization, embeddings, BERT, and applied NLP.
</div>
...
LLMs, prompt engineering, RAG, fine-tuning, agents.
</div>
...
MDPs, Q-learning, policy gradients, robotics and simulation.
</div>
...
Curated courses, books, papers, blogs, tools, and competitions.
</div>

<div class="hub-card" markdown>
### [Project Ideas](projects/index.md)
Categorized project briefs, beginner through advanced.
</div>
...
Content runs along a single difficulty axis so you always know where you are:
